...
const Edit = () => {
  ...
  const { serviceId } = useParams(); // get :id from route
  ...
  return (
    ...
    <main className='flex h-full'>
        ...
        <h1 className="text-center mb-4 font-mono text-4xl">Services Dashboard</h1>
        <div className="p-4">
        <div className="bg-white rounded shadow-md p-4">
            <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-bold">Edit Services</h2>
            ...
            {  formData.image  && (   
                <img src={fileUrl+'uplodes/services/small/'+formData.image} alt='Service Image'/>
            )}
            </div>
